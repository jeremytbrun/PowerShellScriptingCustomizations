...
#         $ExecutionTimeSpan = (get-history)[-1] | % { "{0:c}" -f (new-timespan $_.StartExecutionTime $_.EndExecutionTime) }
#     }
#     else {
#         $ExecutionTimeSpan = '00:00:00.0000000'
#     }

#     $returnedPrompt = "PS [$ExecutionTimeSpan] $($executionContext.SessionState.Path.CurrentLocation)$('>' * ($nestedPromptLevel + 1))"
#     $returnedPrompt
# }
